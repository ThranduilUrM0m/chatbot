...
const initialState = {
    ...
    _conversation: {},
    _conversationToEdit: {},
    _conversationIsAuthenticated: false
}

export const useConversationStore = create(persist(
    (set, get) => ({
        ...initialState,
        ...generateStateActions('_conversations', ACTION_TYPES, set, initialState),
        ...generateStateActions('_conversation', ACTION_TYPES, set, initialState),
        ...generateStateActions('_conversationToEdit', ACTION_TYPES, set, initialState),
        ...generateStateActions('_conversationIsAuthenticated', ACTION_TYPES, set, initialState),
    }),
    {
        name: '_conversationStorage',
