...
const initialState = {
    ...
    _notification: {},
    _notificationToEdit: {},
    _notificationIsAuthenticated: false
}

export const useNotificationStore = create(persist(
    (set, get) => ({
        ...initialState,
        ...generateStateActions('_notifications', ACTION_TYPES, set, initialState),
        ...generateStateActions('_notification', ACTION_TYPES, set, initialState),
        ...generateStateActions('_notificationToEdit', ACTION_TYPES, set, initialState),
        ...generateStateActions('_notificationIsAuthenticated', ACTION_TYPES, set, initialState),
    }),
    {
        name: '_notificationStorage',
