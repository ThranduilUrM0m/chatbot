...
export const usePermissionStore = create(persist(
    (set, get) => ({
        ...initialState,
        ...generateStateActions('_permissions', ACTION_TYPES, set, initialState),
        ...generateStateActions('_permission', ACTION_TYPES, set, initialState),
        ...generateStateActions('_permissionToEdit', ACTION_TYPES, set, initialState),
    }),
    {
